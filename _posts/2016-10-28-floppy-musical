...
Este post descreve como montar o projeto de MoppyAdvanced de <a href="https://github.com/SammyIAm" Sammy1Am\>
...
Primeiramente este projeto é baseado no projeto do Sammy1Am que você encontra <a href="https://github.com/SammyIAm/Moppy" aqui\>.
Além de baixar os arquivos do projeto você precisará da biblioteta <a href="https://code.google.com/archive/p/arduino-timerone/downloads" TimerOne\>
para arduino e do JDK 7 ou mais atual instalado. Eu sugiro que você use o <a href="https://netbeans.org/" NetBeans \> para compilar 
...
Por padrão cada floppy opera a 5 volts e segundo <a href="http://forum.arduino.cc/index.php?topic=152419.0" este tópico\> cada 
